    ...
    <section className="aboutMe" id="aboutMe">
      ...
      <div className="aboutMe__content">
        <p>
          ...
          HTML, CSS, and JavaScript. If you're interested in going more in depth
          into my previous projects, you can find them on this page or on my
          GitHub account.
        </p>
        <p>
          If you'd ask me to describe myself, I would say that I'm a
          goal-oriented person, who is willing to learn new things. While I may
          not be an expert yet, I'm definitely looking for a workplace where I
          can grow as a developer and expand my knowledge.
        </p>
        <p>
